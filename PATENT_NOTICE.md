...
This repository (swarm-it-auth) provides **authentication and session management** infrastructure that supports the Swarm-It platform but does not itself implement the patented RSCT technology.
